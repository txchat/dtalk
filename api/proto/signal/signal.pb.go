...
func (x *SignalFocusMessage) GetMid() string {
	if x != nil {
		return x.Mid
	}
	return ""
...
func (x *SignalRevoke) GetMid() string {
	if x != nil {
		return x.Mid
	}
	return ""
...
var file_github_com_txchat_dtalk_api_proto_signal_proto_rawDesc = []byte{
	...
	0x6d, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x69, 0x64, 0x12, 0x10,
