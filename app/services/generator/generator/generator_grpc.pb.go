...
func (c *generatorClient) GetID(ctx context.Context, in *GetIDReq, opts ...grpc.CallOption) (*GetIDReply, error) {
	out := new(GetIDReply)
	err := c.cc.Invoke(ctx, "/generator.Generator/GetID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GeneratorServer interface {
	GetID(context.Context, *GetIDReq) (*GetIDReply, error)
...
func (UnimplementedGeneratorServer) GetID(context.Context, *GetIDReq) (*GetIDReply, error) {
...
func _Generator_GetID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/generator.Generator/GetID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GeneratorServer).GetID(ctx, req.(*GetIDReq))
	}
