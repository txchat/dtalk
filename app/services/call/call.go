...
import (
	...
	"github.com/txchat/dtalk/app/services/call/internal/server"
...
var (
	...
	// configFile 配置文件路径
	configFile = flag.String("f", "etc/call.yaml", "the config file")
)
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		call.RegisterCallServer(grpcServer, server.NewCallServer(ctx))
