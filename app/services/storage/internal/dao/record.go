...
func (repo *UniRepository) AppendMsgContent(tx *mysql.MysqlTx, m *model.MsgContent) (int64, int64, error) {
...
func (repo *UniRepository) AppendMsgRelation(tx *mysql.MysqlTx, m *model.MsgRelation) (int64, int64, error) {
	num, lastId, err := tx.Exec(_InsertMsgRelation,
		m.Mid, m.OwnerUid, m.OtherUid, m.Type, m.State, m.CreateTime)
	return num, lastId, err
}

func (repo *UniRepository) MarkMsgReceived(uid string, mid int64) (int64, int64, error) {
	num, lastId, err := repo.mysql.Exec(_SetRecordState, model.Received, uid, mid)
	return num, lastId, err
}

func (repo *UniRepository) DelMsgContent(mid int64) (int64, int64, error) {
	num, lastId, err := repo.mysql.Exec(_DelMsgContent, mid)
	return num, lastId, err
}

func (repo *UniRepository) UnReceiveMsg(uid string) ([]*model.MsgContent, error) {
	maps, err := repo.mysql.Query(_GetUnReceiveMsg, uid, model.UnReceive)
	if err != nil {
		return nil, err
	}
...
func (repo *UniRepository) UserLastMsg(uid string, num int64) ([]*model.MsgContent, error) {
...
func (repo *UniRepository) UserMsgAfter(uid string, startMid, count int64) ([]*model.MsgContent, error) {
...
func (repo *UniRepository) IncMsgVersion(uid string) (uint64, error) {
...
//group
func (repo *UniRepository) AppendGroupMsgContent(tx *mysql.MysqlTx, m *model.MsgContent) (int64, int64, error) {
	num, lastId, err := tx.Exec(_InsertGroupMsgContent,
		m.Mid, m.Seq, m.SenderId, m.ReceiverId, m.MsgType, m.Content, m.CreateTime, m.Source, m.Reference)
	return num, lastId, err
}

func (repo *UniRepository) AppendGroupMsgRelation(tx *mysql.MysqlTx, m []*model.MsgRelation) (int64, int64, error) {
...
func (repo *UniRepository) UnReceiveGroupMsg(uid string) ([]*model.MsgContent, error) {
...
func (repo *UniRepository) GroupMsgAfter(uid string, startMid, count int64) ([]*model.MsgContent, error) {
...
// GetPriRecord 获得聊天记录
func (repo *UniRepository) GetPriRecord(fromId, targetId string, mid int64, recordCount int64) ([]*model.MsgContent, error) {
...
// GetRecord 获得指定聊天记录
func (repo *UniRepository) GetSpecifyRecord(mid int64) (*model.MsgContent, error) {
...
func (repo *UniRepository) GetSpecifyGroupRecord(mid int64) (*model.MsgContent, error) {
