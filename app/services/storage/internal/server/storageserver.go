...
func (s *StorageServer) GetRecordsAfterMid(ctx context.Context, in *storage.GetRecordsAfterMidReq) (*storage.GetRecordsAfterMidReply, error) {
	l := logic.NewGetRecordsAfterMidLogic(ctx, s.svcCtx)
	return l.GetRecordsAfterMid(in)
}

func (s *StorageServer) GetSyncRecordsAfterMid(ctx context.Context, in *storage.GetSyncRecordsAfterMidReq) (*storage.GetSyncRecordsAfterMidReply, error) {
	l := logic.NewGetSyncRecordsAfterMidLogic(ctx, s.svcCtx)
	return l.GetSyncRecordsAfterMid(in)
}
