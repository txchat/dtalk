...
// record --> mq
type ThirdPartyPushMQ struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	AppId       string          `protobuf:"bytes,1,opt,name=appId,proto3" json:"appId,omitempty"`
	ChannelType message.Channel `protobuf:"varint,2,opt,name=channelType,proto3,enum=dtalk.api.proto.Channel" json:"channelType,omitempty"`
	...
	Datetime    int64           `protobuf:"varint,7,opt,name=datetime,proto3" json:"datetime,omitempty"`
}

func (x *ThirdPartyPushMQ) Reset() {
	*x = ThirdPartyPushMQ{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_txchat_dtalk_internal_proto_offline_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ThirdPartyPushMQ) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ThirdPartyPushMQ) ProtoMessage() {}

func (x *ThirdPartyPushMQ) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_txchat_dtalk_internal_proto_offline_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ThirdPartyPushMQ.ProtoReflect.Descriptor instead.
func (*ThirdPartyPushMQ) Descriptor() ([]byte, []int) {
	return file_github_com_txchat_dtalk_internal_proto_offline_proto_rawDescGZIP(), []int{1}
}

func (x *ThirdPartyPushMQ) GetAppId() string {
	if x != nil {
		return x.AppId
	}
	return ""
...
func (x *ThirdPartyPushMQ) GetChannelType() message.Channel {
	if x != nil {
		return x.ChannelType
	}
...
func (x *ThirdPartyPushMQ) GetSession() string {
	if x != nil {
		return x.Session
	}
	return ""
...
func (x *ThirdPartyPushMQ) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
func (x *ThirdPartyPushMQ) GetTarget() []string {
	if x != nil {
		return x.Target
	}
	return nil
...
func (x *ThirdPartyPushMQ) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
func (x *ThirdPartyPushMQ) GetDatetime() int64 {
	if x != nil {
		return x.Datetime
	}
	return 0
...
var file_github_com_txchat_dtalk_internal_proto_offline_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xed, 0x01, 0x0a, 0x0a, 0x4f, 0x66, 0x66, 0x50, 0x75, 0x73, 0x68,
	0x4d, 0x73, 0x67, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x70, 0x70, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x61, 0x70, 0x70, 0x49, 0x64, 0x12, 0x2f, 0x0a, 0x06, 0x64, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x64, 0x74, 0x61, 0x6c,
	0x6b, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x44, 0x65, 0x76, 0x69,
	0x63, 0x65, 0x52, 0x06, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69,
	...
	,
	...
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x66, 0x72, 0x6f, 0x6d, 0x18, 0x04, 0x20,
	...
	0x61, 0x74, 0x65, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x64,
	0x61, 0x74, 0x65, 0x74, 0x69, 0x6d, 0x65, 0x42, 0x38, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x78, 0x63, 0x68, 0x61, 0x74, 0x2f, 0x64, 0x74, 0x61,
	0x6c, 0x6b, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2f, 0x6f, 0x66, 0x66, 0x6c, 0x69, 0x6e, 0x65, 0x3b, 0x6f, 0x66, 0x66, 0x6c, 0x69, 0x6e,
...
var file_github_com_txchat_dtalk_internal_proto_offline_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_github_com_txchat_dtalk_internal_proto_offline_proto_goTypes = []interface{}{
	(*OffPushMsg)(nil),       // 0: dtalk.offline.OffPushMsg
	(*ThirdPartyPushMQ)(nil), // 1: dtalk.offline.ThirdPartyPushMQ
	(auth.Device)(0),         // 2: dtalk.api.proto.Device
	(message.Channel)(0),     // 3: dtalk.api.proto.Channel
}
var file_github_com_txchat_dtalk_internal_proto_offline_proto_depIdxs = []int32{
	2, // 0: dtalk.offline.OffPushMsg.device:type_name -> dtalk.api.proto.Device
	3, // 1: dtalk.offline.ThirdPartyPushMQ.channelType:type_name -> dtalk.api.proto.Channel
...
func file_github_com_txchat_dtalk_internal_proto_offline_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_txchat_dtalk_internal_proto_offline_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ThirdPartyPushMQ); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
