...
var (
	...
	ErrPersonOutOfGroup            = NewError(-10006, "对方已不在本群中")
	...
	ErrYouAreOutOfGroup            = NewError(-10015, "你已不在本群中")
	ErrGroupMemberNotExist         = NewError(-10016, "群成员不存在")
	...
	ErrGroupNotExist               = NewError(-10026, "群不存在")
